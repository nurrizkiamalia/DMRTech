        ...
        <div className="">
            <div className="flex gap-5 flex-col items-start">
                ...
                <div>
                    ...
                    <h1 className="xl:text-heading1 lg:text-heading2 md:text-heading3 text-[35px] font-dmBricolage capitalize tracking-tight font-semibold leading-snug hover:rotate-3 transition-all ease-linear ">
                            🚀 
                            Crafting Lightning-Fast  & Stunning Websites 
                    </h1>
                </div>
                ...
                <div className="flex gap-5 items-center mb-10">
                    <ButtonToService />
                    <Link href={"/About"} className="underline text-pLg hover:scale-110 transition-all ease">Our History</Link>
                </div>
            </div>
        </div>
    )
