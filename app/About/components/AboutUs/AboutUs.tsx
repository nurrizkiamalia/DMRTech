        ...
        <>
          <TwoContent className="pt-[15vh] xl:pt-[25vh] !flex !flex-col !gap-5">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 items-start">
              ...
              <p className="col-start-1 font-raleway text-pL">Discover our journey from a small startup to a leading tech innovator. Our dedicated team of professionals is driven by a shared passion for technology and excellence. </p>
            </div>
            <AboutUsImg />
          </TwoContent>
        </>
